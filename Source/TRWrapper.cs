...
namespace DF
{
    ...
    {
        protected static System.Type TRType;
        protected static System.Type TRPersonaliserType;

        protected static Object actualTR = null;
        protected static Object actualTRPersonaliser = null;
        ...
        /// SET AFTER INIT
        /// </summary>
        public static TRPersonaliserAPI TexRepPersonaliser = null;
        ...
        public class TRPersonaliserAPI
        {
            ...
            internal void personaliseIva(Kerbal kerbal)
            {
                try
                {
                    personaliseIvaMethod.Invoke(APIactualTRPersonaliser, new System.Object[] { kerbal });
                }
                catch (Exception ex)
                {
