...
namespace DF
{
    ...
    public class KACWrapper
    {
        ...
        /// SET AFTER INIT
        /// </summary>
        private static Boolean _KACWrapped;
        ...
        public class KACAPI
        {
            ...
            {
                return (String)CreateAlarmMethod.Invoke(actualKAC, new Object[] { (Int32)AlarmType, Name, UT });
            }
            ...
            {
                return (Boolean)DeleteAlarmMethod.Invoke(actualKAC, new Object[] { AlarmID });
            }
            ...
            internal Boolean DrawAlarmActionChoice(ref AlarmActionEnum Choice, String LabelText, Int32 LabelWidth, Int32 ButtonWidth)
            {
                ...
                Int32 OutValue = (Int32)DrawAlarmActionChoiceMethod.Invoke(actualKAC, new Object[] { InValue, LabelText, LabelWidth, ButtonWidth });
